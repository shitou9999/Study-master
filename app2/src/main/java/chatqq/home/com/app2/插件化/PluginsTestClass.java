package chatqq.home.com.app2.插件化;
...
public class PluginsTestClass extends Activity {


    final String classFullName = "chatqq.home.com.app2.插件化.com.cacard.test.DynamicClass";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
//        setContentView(R.layout.activity_plugins_test_class);错误删掉
    ...
    private void loadClassFromDex() {
        ...
        checkDir(optDir);
        //依赖的lib
        String libSeachPath = null;

        ClassLoader parentClassLoader = getClassLoader();//父Loader
        ...
        try {
            DexClassLoader dexClassLoader = new DexClassLoader(dexPath, optDir, libSeachPath, parentClassLoader);
            ...
            //opt放到sd后出错。
            //Optimized data directory /storage/emulated/0/dcopt is not owned by the current user.
    ...
    /**
     * PathClassLoader 只能从已安装的class中加载
     */
